...
if lightline#colorscheme#background() ==# 'light'
	...
	let s:p.normal.left = [[ s:bryellow, s:cordovan ], [ s:cordovan, s:bryellow ]]
	let s:p.normal.right = [[ s:bryellow, s:cordovan ], [ s:bryellow, s:blue ], [ s:cordovan, s:bryellow ]]
	...
	let s:p.visual.right = [[ s:bryellow, s:orange ], [ s:bryellow, s:blue ], [ s:cordovan, s:bryellow ]]

	let s:p.inactive.left = [[ s:cordovan, s:white ], [ s:cordovan, s:white ]]
	let s:p.inactive.middle = [[ s:cordovan, s:white ], [ s:cordovan, s:white ]]
	let s:p.inactive.right = [[ s:cordovan, s:white  ], [ s:cordovan, s:white ]]

	let s:p.replace.left = [[ s:bryellow, s:red ], [ s:cordovan, s:bryellow ]]
	let s:p.replace.right = [[ s:bryellow, s:red ], [ s:bryellow, s:blue ], [ s:cordovan, s:bryellow ]]
